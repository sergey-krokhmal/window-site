                    ...
                    <nav class="header-menu">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="dropdown col-md-2">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="#">предложение о сотрудничестве</a></li>
                                    <li><a href="#">коммерческое предложение</a></li>
                                    <li><a href="#">предложение</a></li>
                                    <li><a href="#">система скидок диллерам</a></li>
                                    <li><a href="#">памятка диллерам</a></li>
                                    <li><a href="#">стать диллерам</a></li>
                                </ul>
                            </li>
                            <li class="dropdown col-md-2">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    ...
                                    <li><a href="#">технический каталог</a></li>
                                    <li><a href="#">статьи</a></li>
                                    <li><a href="#">словарь терминов</a></li>
                                </ul>
                            </li>
                            <li class="col-md-2"><a href="/">Где купить</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
